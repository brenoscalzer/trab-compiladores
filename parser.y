...
constant:
  I_CONSTANT { $$ = INT_TYPE; }		/* includes character_constant */
| F_CONSTANT
...
| postfix_expression PTR_OP IDENTIFIER    {  check_var();  }
...
| SHORT                { last_decl_type = SHORT_TYPE; }
| INT                  { last_decl_type = INT_TYPE; }
| LONG                 { last_decl_type = LONG_TYPE; }
| FLOAT                { last_decl_type = FLOAT_TYPE; }
| DOUBLE               { last_decl_type = DOUBLE_TYPE; }
| SIGNED               { last_decl_type = SIGNED_TYPE; }
| UNSIGNED             { last_decl_type = UNSIGNED_TYPE; }
| BOOL                 { last_decl_type = BOOL_TYPE; }
| COMPLEX              { last_decl_type = COMPLEX_TYPE; }
| IMAGINARY	  	       { last_decl_type = IMAGINARY_TYPE; }
...
| struct_or_union IDENTIFIER '{' struct_declaration_list '}'    {  check_var();  }
| struct_or_union IDENTIFIER      {  check_var();  }
;
...
| ENUM '{' enumerator_list ',' '}'
| ENUM IDENTIFIER '{' enumerator_list '}'       {  check_var();  }
| ENUM IDENTIFIER '{' enumerator_list ',' '}'   {  check_var();  }
| ENUM IDENTIFIER                               {  check_var();  }
;
...
labeled_statement:
  IDENTIFIER ':' statement                      {  check_var();  }
